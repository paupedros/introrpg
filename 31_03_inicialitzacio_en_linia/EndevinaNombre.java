...
public class EndevinaNombre {
    public static void main(String[] args) {
        ...
        int numeroPensat = Integer.parseInt(args[0]); // Declara la variable del numero pensat i la inicialitza amb el numero pensat
        ...
        int numero = numeroPensat * 3; // Declara i inicialitza la variable numero
