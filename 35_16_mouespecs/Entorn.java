...
public class Entorn {
    ...
    public void processaModifica() {
        ...
        System.out.println(String.format("Modificat:%n    Vi: %s%n    Preu: %d%n    Estoc: %d%n", vi.getEspec().getNom(),
    ...
    public void processaElimina() {
        ...
        // Si es troba el vi
        System.out.println(String.format("A eliminar:%n    Vi: %s%n    Preu: %d%n    Estoc: %d%n", vi.getEspec().getNom(),
                vi.getPreu(), vi.getEstoc()));
        ...
        if (confirm) {
            Vi deleted = botiga.elimina(vi.getEspec().getNom());
