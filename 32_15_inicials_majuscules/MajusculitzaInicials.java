...
/* En aquest programa introduim un text i capitalitzarem cada paraula que estigui entre caracters que
	no siguin lletres. Les dades d'entrada les obtenim amb el main, el tractament d'aquestes dades
	amb un modul parametritzat */
